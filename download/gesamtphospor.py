...
gesamtphosphor = '/html/body/div/div[1]/div[2]/form/div[3]/div[2]/div/div[2]/div/span/div/div[3]/div[7]/div/span[2]/span[2]/table/tbody/tr/td[2]/span'

wait_clickable(gesamtphosphor)
...
for i in range(216, 364):
    ...
    # e.send_keys(Keys.RETURN)
    driver.execute_script('var e = document.getElementById("selectorForm:j_idt607:tableCondition"); e.value = {}; $(e).trigger("change")'.format(i))
    time.sleep(1)
    # Open download menu
    wait_clickable('/html/body/div[1]/div[1]/div[2]/form/div[10]/span[1]/div')
    ## Click download
